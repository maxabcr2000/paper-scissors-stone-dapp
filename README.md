...
$ HTTP_DISPATCHER_URL="http://127.0.0.1:5004" gunicorn --reload --workers 1 --bind 0.0.0.0:5003 paper-scissors-stone:app
```

This will run the paper-scissors-stone server on port `5003` and send the corresponding notices to port `5004`. The server will also automatically reload if there is a change in the source code, enabling fast development iterations.
...
```
[2022-01-21 12:38:23,971] INFO in paper-scissors-stone: HTTP dispatcher url is http://127.0.0.1:5004
...
```shell
[2022-01-21 15:58:39,555] INFO in paper-scissors-stone: Received advance request body {'metadata': {'msg_sender': '0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266', 'epoch_index': 0, 'input_index': 0, 'block_number': 11, 'time_stamp': 1642791522}, 'payload': '0x636172746573690d0a'}
[2022-01-21 15:58:39,556] INFO in paper-scissors-stone: Adding notice
[2022-01-21 15:58:39,650] INFO in paper-scissors-stone: Received notice status 201 body b'{"index":0}'
[2022-01-21 15:58:39,651] INFO in paper-scissors-stone: Finishing
[2022-01-21 15:58:39,666] INFO in paper-scissors-stone: Received finish status 202
```
